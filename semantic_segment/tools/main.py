...
# deeplab_model = torchvision.models.segma_transformentation.deeplabv3_resnet50(pretrained=True)
...
train_loader = Data.DataLoader(dataset=train_set, batch_size=10)
val_loader = Data.DataLoader(dataset=val_set, batch_size=10)
...
loss_f = nn.CrossEntropyLoss(weight=class_weights).cuda()
